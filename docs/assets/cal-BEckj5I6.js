var ee=Object.defineProperty;var te=(h,t,e)=>t in h?ee(h,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):h[t]=e;var D=(h,t,e)=>te(h,typeof t!="symbol"?t+"":t,e);import{t as J,f as se,n as ae,a as Q,w as j,b as Y,g as ne,c as oe,d as le,e as ie,h as re,i as W,j as z}from"./model-8AZnbWHn.js";import{C as k,U as T,I as ce,A as de}from"./auth-Cml8w5An.js";import{LitElement as O,css as X,html as b,nothing as x}from"https://cdn.jsdelivr.net/gh/lit/dist@2.8.0/core/lit-core.min.js";import y from"https://cdn.jsdelivr.net/npm/dayjs@1.11.10/+esm";import{unsafeHTML as he}from"https://cdn.jsdelivr.net/npm/lit-html@2.8.0/directives/unsafe-html.min.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";import"https://cdn.jsdelivr.net/npm/lit-html@2.8.0/directives/live.min.js";class pe extends O{createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.monthTextDiv=this.querySelector(".cal-navbar-month"),this.dateSelector=this.querySelector(".cal-navbar-datesel"),this.dateSelectorIcon=this.querySelector(".cal-navbar-datesel-icon");const t=this.getAttribute("cal-id");this.parent=document.querySelector("#"+t),this.parent.addEventListener("displaying-month",this._handleDisplayMonth.bind(this)),this.dateSelector.addEventListener("change",()=>this.selectDate(this.dateSelector.value)),this.querySelector(".cal-navbar-datesel-icon").addEventListener("click",()=>this.dateSelector.showPicker()),this.querySelector("#cal-navbar-today-btn").addEventListener("click",()=>this.today()),this.querySelector("#cal-navbar-prevmonth").addEventListener("click",()=>this.prevMonth()),this.querySelector("#cal-navbar-nextmonth").addEventListener("click",()=>this.nextMonth())}today(){this.parent.scrollToDate(y(),"auto")}selectDate(t){this.parent.scrollToDate(t,"auto")}prevMonth(){this.parent.scrollToMonth(y(this.dateSelector.value).subtract(1,"month").format("YYYY-MM"))}nextMonth(){this.parent.scrollToMonth(y(this.dateSelector.value).add(1,"month").format("YYYY-MM"))}_handleDisplayMonth(t){t.detail.monthObj?(this.monthTextDiv.textContent=t.detail.monthObj.format("MMMM YYYY"),this.dateSelector.value=t.detail.monthObj.format("YYYY-MM-DD")):this.monthTextDiv.textContent=""}}customElements.define("cal-navbar",pe);class ue{constructor(){this.clear()}clear(){this._actions=[],this._curAction=-1}add(t){this._curAction++,this._actions[this._curAction]=t,this._actions[this._curAction+1]&&this._actions.splice(this._curAction+1)}undo(){return this.hasUndo()?this._actions[this._curAction--]:null}redo(){return this.hasRedo()?this._actions[++this._curAction]:null}hasUndo(){return this._curAction>=0}hasRedo(){return this._curAction<this._actions.length-1}}const fe="data:image/svg+xml,%3csvg%20width='24'%20height='24'%20viewBox='0%200%2024%2024'%20xmlns='http://www.w3.org/2000/svg'%3e%3cstyle%3e.spinner_b2T7{animation:spinner_xe7Q%20.8s%20linear%20infinite}.spinner_YRVV{animation-delay:-.65s}.spinner_c9oY{animation-delay:-.5s}@keyframes%20spinner_xe7Q{93.75%25,100%25{r:3px}46.875%25{r:.2px}}%3c/style%3e%3ccircle%20class='spinner_b2T7'%20cx='4'%20cy='12'%20r='3'/%3e%3ccircle%20class='spinner_b2T7%20spinner_YRVV'%20cx='12'%20cy='12'%20r='3'/%3e%3ccircle%20class='spinner_b2T7%20spinner_c9oY'%20cx='20'%20cy='12'%20r='3'/%3e%3c/svg%3e";class I extends O{constructor(){super();D(this,"forceRefresh",J((e=null)=>{const s=e?e.map(a=>"#day-"+a):"cal-day";this.requestUpdate(),this.shadowRoot.querySelectorAll(s).forEach(a=>a.forceRefresh())},250));this.data=null,this._undo=new ue,this._selecting=!1,this._firstSelectedIdx=null,this._lastSelectedIdx=null}connectedCallback(){super.connectedCallback(),this.addEventListener("cal-day-change",this._handleDayChange),this.addEventListener("cal-day-mousedown",this._handleMouseDown),this.addEventListener("cal-day-mouseover",this._handleMouseOver),this.addEventListener("cal-day-mouseup",this._handleMouseUp)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("cal-day-change",this._handleDayChange),this.removeEventListener("cal-day-mousedown",this._handleMouseDown),this.removeEventListener("cal-day-mouseover",this._handleMouseOver),this.removeEventListener("cal-day-mouseup",this._handleMouseUp)}render(){return this.data?b`
    ...
    `:b`<div class="loading">
        ${this.loadingText??b`<img src="${fe}" style="height:48px" />`}
      </div>`}renderDay(e,s){var d,p,f,g;const a=y().format("YYYY-MM-DD");let n="";if(e.dayObj.day()%7===1)if(e.dayObj.date()<=7&&this._wholeWeekInSameMonth(e.dayObj)){const v=e.dayObj;n=b`<div
          id="month-${v.format("YYYY-MM")}"
          class="cal-month-gutter"
        >
          <div class="fw-bold">${v.year()}</div>
          <div>${v.format("MMM").toUpperCase()}</div>
        </div>`}else n=b`<div class="cal-month-gutter"></div>`;const o=e.dayStr,l=e.dayObj.date()==1?"first-day":x,i=((d=this.data)==null?void 0:d[o])??{cals:{}},r=(p=this.alerts)==null?void 0:p[o],c=this.settings??{cals:{},options:{}};return b`${n}
      <cal-day
        id="day-${o}"
        class="${l}"
        day="${e.display?e.display:e.dayObj.date()}"
        dim=${o<a||x}
        note="${((f=i==null?void 0:i.note)==null?void 0:f.text)||(i==null?void 0:i.note)||x}"
        noteStyle="${((g=i==null?void 0:i.note)==null?void 0:g.style)||x}"
  ...
  `),D(I,"properties",{loadingText:{type:String},readonly:{type:Boolean},start:{type:String},end:{type:String},alerts:{type:Object,attribute:!1}});customElements.define("cal-component",I);class Z extends O{render(){if(!this.settings)return;const{cals:t,options:e}=this.settings??{},{calOrder:s}=e??{},a=s==null?void 0:s.map(o=>{var l,i,r,c;return{id:o,label:(l=t[o])==null?void 0:l.name,color:((i=t[o])==null?void 0:i.color)||((r=t[o])==null?void 0:r.background),checked:((c=t[o])==null?void 0:c.visible)??k}}),n=b`<cal-checklist
      checkable
      .items=${a??[]}
      @checked=${this._handleCalChange}
      @color-change=${this._handleCalChange}>
    </calchecklist>`;return b` ${n} `}_handleCalChange(t){const{item:e,checked:s,color:a}=t.detail;this.dispatchEvent(new CustomEvent("change",{bubbles:!1,composed:!0,detail:{cal:e.id,checked:s,color:a}}))}}D(Z,"properties",{settings:{type:Object,attribute:!1}});customElements.define("cal-callist",Z);class A extends O{willUpdate(){if(!this.settings)return;let t=this.settings.options??{};t=this.settings.options={peopleGroupOrder:[],peopleGroups:{},people:{},...t};for(const e in t.people)t.people[e].visible=t.people[e].visible??k;this._syncGroupsToPeopleChecked(t.peopleGroups,t.people)}render(){if(!this.settings)return;const{peopleGroupOrder:t,peopleGroups:e,people:s}=this.settings.options??{},a=t==null?void 0:t.map(c=>{var d;return{label:c,group:!0,checked:((d=e[c])==null?void 0:d.visible)??T}}),n=Object.entries(s??{}).map(([c,d])=>d.name).filter((c,d,p)=>p.indexOf(c)===d).sort().map(c=>{var d,p;return{label:c,group:!1,checked:((d=s[c])==null?void 0:d.visible)??k,color:(p=s[c])==null?void 0:p.color}}),o=b`<cal-checklist
      checkable
      .items=${a}
    ...
    >
      ...
      <a href="#" @click=${this._handleSelectAll.bind(this,k)}
        >Show All</a
      >
      |
      <a href="#" @click=${this._handleSelectAll.bind(this,T)}>None</a>
    </div>`;return b`${o} ${l} ${i} ${r} ${l}`}_syncGroupsToPeopleChecked(t,e){for(const s in t){const a=t[s].names,n=a.filter(o=>{var l;return(l=e[o])==null?void 0:l.visible});t[s].visible=n.length==a.length?k:n.length>0?ce:T}}_dispatch(t){this.dispatchEvent(new CustomEvent(t,{bubbles:!1,composed:!0,detail:{settings:this.settings}}))}_handleColorChange(t){const{item:e,color:s}=t.detail;e.group?this.settings.options.peopleGroups[e.label].color=s:this.settings.options.people[e.label].color=s,this._dispatch("change")}_handleGroupCheck(t){const{item:e,checked:s}=t.detail;for(const a of this.settings.options.peopleGroups[e.label].names)a in this.settings.options.people&&(this.settings.options.people[a].visible=s?k:T);this._dispatch("change"),this.requestUpdate()}_handlePersonCheck(t){const{item:e,checked:s}=t.detail;this.settings.options.people[e.label].visible=s?k:T,this._dispatch("change"),this.requestUpdate()}_handleSelectAll(t){const e=this.settings.options.people;for(const s in e)e[s].visible=t;this._dispatch("change"),this.requestUpdate()}}D(A,"properties",{settings:{type:Object,attribute:!1}}),D(A,"styles",X`
    :host {
      display: flex;
      flex-direction: column;
    }
  ...
  `);customElements.define("cal-peoplelist",A);const R=document.querySelector("#reportModal"),me=R.querySelector(".modal-title"),ye=R.querySelector(".modal-body"),F=new bootstrap.Modal(R),U={setTitle:h=>{me.textContent=h},setBodyHtml:h=>{ye.innerHTML=h},show:(h,t)=>{h!==void 0&&U.setTitle(h),t!==void 0&&U.setBodyHtml(t),F.show()},hide:()=>{F.hide()}};function M(h,t,e){var l,i;const s={};se(t,h,({day:r,calId:c,resource:d,shift:p,subitemResource:f,subitemShift:g})=>{var _,m;const v=(m=(_=e.cals)==null?void 0:_[c])==null?void 0:m.type;if((v==null?void 0:v.toLowerCase())!="call"){d=f??d,p=g??p;const u=d.toLowerCase(),w=s[u]??{display:d},S=w[r]??[];S.push(p),w[r]=S,s[u]=w}});const a={},n=Object.keys(s).sort();for(const r of h)for(const c of n){const d=c.toLowerCase();let p=0;const f=s[d][r]??[];for(const g of f)p+=((l=ae(r,g))==null?void 0:l.hours)||0;a[d]=a[d]??{display:s[d].display},a[d][r]=p}n.forEach(r=>{a[r].total=Object.values(a[r]).reduce((c,d)=>c+(isNaN(d)?0:d),0)});const o=Object.values(((i=e.options)==null?void 0:i.people)??{}).map(r=>r.visible??!0?r.name.toLowerCase():null).filter(r=>r);for(const r of Object.keys(a))o.includes(r)||delete a[r];return{days:h,people:Object.keys(a),data:a}}function be(h,t=null,e=null,s=null){const{days:a,people:n,data:o}=h,l=n.map(c=>`<th>${o[c].display}</th>`),i=a.map(c=>{const d=`<td>${y(c).format("dd M/D/YY")}</td>`,p=n.map(f=>o[f][c]).map(f=>`<td>${f}</td>`);return[d,...p]}).map(c=>`<tr>${c.join("")}</tr>`),r=n.map(c=>`<td>${o[c].total}</td>`);if(i.push(`<tr><td><i>Total</i></td>${r.join("")}</tr>`),t&&e||s){if(i.unshift(`<tr><th colspan="${n.length+1}">Selected Days</th></tr>`),t&&e){const c=n.map(d=>{var p;return`<td>${((p=e.data[d])==null?void 0:p.total)??""}</td>`});i.push(`<tr><th>Total to ${y(t).format("M/D/YY")}</th>${c.join("")}</tr>`)}if(s){const c=n.map(d=>{var p;return`<td>${((p=s.data[d])==null?void 0:p.total)??""}</td>`});i.push(`<tr><th>Total for ${y(t).year()}</th>${c.join("")}</tr>`)}}return`<table class="table table-striped">
    <thead>
      <tr>
        <th></th>
        ${l.join("")}
  ...
  </table>`}class ve extends O{constructor(){super(),this._dayData={cals:{}}}createRenderRoot(){return this}willUpdate(t){var e,s,a;this._calData=(e=this._calEl)==null?void 0:e.data,this._settings=((s=this._calEl)==null?void 0:s.settings)??{cals:{}},this._alerts=((a=this._calEl)==null?void 0:a.alerts)??{},this._renderInfo=this._createRenderInfo(this._selected,this._settings,this._dayData,this._alerts,this._calEl.readonly)}_createRenderInfo(t,e,s,a,n){var d,p;const o=this._selectedDaysAsText(t)||"Select a date",l=(t==null?void 0:t.length)==1?x:!0,i={};t.filter(f=>!!a[f]).forEach(f=>i[f]=a[f]);const r=(d=e.templates)==null?void 0:d.map((f,g)=>b`<option value="${g}">${f.name}</option>`),c=Object.keys(((p=e.options)==null?void 0:p.people)??{}).map(f=>b`<option value="${f}"></option>`);return{dayData:s,calSettings:e,selectedDaysText:o,selectedAlerts:i,copyDisabled:l,templateOptions:r,peopleDatalist:c,readonly:n}}render(){if(!this._renderInfo)return;const{dayData:t,calSettings:e,selectedDaysText:s,selectedAlerts:a,copyDisabled:n,templateOptions:o,peopleDatalist:l,readonly:i}=this._renderInfo,r=b`
    ...
    </table>`}}customElements.define("cal-action-panel",ve);function L(h,t,e={}){var n;const s=(n=t==null?void 0:t.templates)==null?void 0:n.filter(o=>o.type=="regular"),a=we(s);return e.context=e.context??{},e.context.compiledTemplates=a,e.maxDate=e.maxDate??De(h),ge(h,t,[Se,_e],e)}function ge(h,t,e=[],{days:s=null,minDate:a=Q(),maxDate:n=null,context:o=null}={}){const l={};return s=s??Object.keys(h),s=a?s.filter(i=>i>=a):s,s=n?s.filter(i=>i<=n):s,s.forEach(i=>{const r=l[i]??[];e.forEach(c=>{const d=c(i,h[i],h,t,o);(d==null?void 0:d.length)>0&&r.push(...d)}),r.length&&(l[i]=r)}),l}function _e(h,t,e,s,{compiledTemplates:a=null}){var n;if(a){const o=Object.entries(((n=s.options)==null?void 0:n.people)??{}).filter(([_,m])=>m.visible===0).map(([_,m])=>{var u;return(u=m.name)==null?void 0:u.toLowerCase()}),l=Object.entries(s.cals??{}).filter(([_,m])=>m.visible??!0).map(([_,m])=>_),i=Object.fromEntries(l.map(_=>{var m,u;return[_,(u=(m=s.cals)==null?void 0:m[_])==null?void 0:u.name]})),r=dayjs(h).day(),c=[];Object.values(t.cals).forEach(({id:_,events:m})=>{m.forEach(u=>{var C,q,P,N,H,K;const w=(q=(C=u.resource)==null?void 0:C.trim())==null?void 0:q.toLowerCase(),S=Array.isArray(u.schedule)?(N=(P=u.schedule.join(", "))==null?void 0:P.trim())==null?void 0:N.toLowerCase():(K=(H=u.schedule)==null?void 0:H.trim())==null?void 0:K.toLowerCase();c.push({type:"event",calId:_,resource:w,schedule:S}),u.subitems&&u.subitems.forEach($=>{var B,G,V;c.push({type:"subitem",calId:_,parentResource:w,parentSchedule:S,resource:(B=$.resource)==null?void 0:B.toLowerCase(),schedule:Array.isArray($.schedule)?(G=$.schedule.join(", "))==null?void 0:G.toLowerCase():(V=$.schedule)==null?void 0:V.trim().toLowerCase()})})})});let p=!1,f=!1,g=null,v=null;for(const _ of a.reverse())if(g=_[r],g!=null&&g.length){p=!0,v=new Array(g.length).fill(!1);const m=a.length==1?c:structuredClone(c);if(g.forEach((u,w)=>{if(l.indexOf(u.calId)<0||o.indexOf(u.resource.toLowerCase())>=0)v[w]=!0;else for(const S in m){const C=m[S];if(u.calId==C.calId&&u.type=="event"&&C.type=="event"&&(u.match=="exact"&&u.resource==C.resource&&u.schedule==C.schedule||u.match=="resource"&&u.resource==C.resource||u.match=="schedule"&&u.schedule==C.schedule)){m.splice(S,1),v[w]=!0;break}}}),v.every(u=>!!u)){f=!0;break}}return!p||f?[]:[{type:"info",text:"Changes: "+g.filter((m,u)=>!v[u]).filter(m=>m.resource&&m.resource!="*").map(m=>`${m.display} (${i[m.calId]})`).join(", ")}]}return[]}function we(h){const t=[];if(h){for(const e of h)if(e.format=="week"){const s=Object.entries(e.data).map(([a,{cals:n}])=>[a,Ce(n)]).filter(([a,n])=>n.length);s.length&&t.push(Object.fromEntries(s))}}return t}function Ce(h){const t=[];return Object.values(h).forEach(({id:e,events:s})=>{s.forEach(({resource:a,schedule:n,subitems:o})=>{var i,r,c;const l=Array.isArray(n)?(r=(i=n.join(", "))==null?void 0:i.trim())==null?void 0:r.toLowerCase():(c=n==null?void 0:n.trim())==null?void 0:c.toLowerCase();a==""||a=="*"?t.push({priority:1,type:"event",match:"partialMatchShift",calId:e,display:"missing shift",schedule:l}):a!=""&&((n==null?void 0:n.length)>0||!Array.isArray(n)&&n)&&t.push({priority:0,type:"event",match:"exact",calId:e,resource:a==null?void 0:a.toLowerCase(),display:a,schedule:l})})}),t.length>0&&t.sort((e,s)=>e.priority-s.priority),t}function Se(h,t,e,s,a){var l;const n=Object.keys(((l=s.options)==null?void 0:l.people)??{}).map(i=>i.toLowerCase()),o=[];if(n.length>0){const i=new Set;Object.values(t.cals??{}).forEach(({events:r})=>{r.forEach(({resource:c,subitems:d})=>{c&&!n.includes(c.toLowerCase())&&i.add(c),d==null||d.forEach(({resource:p})=>{p&&!n.includes(p.toLowerCase())&&i.add(p)})})}),i.size>0&&o.push({type:"warn",text:"Unrecognized: "+Array.from(i.values()).join(", ")})}return o}function De(h){let t=Q();return Object.entries(h).forEach(([e,s])=>{(s.note||Object.values(s.cals??{}).findIndex(n=>{var o;return((o=n.events)==null?void 0:o.length)>0})>-1)&&e>t&&(t=e)}),t}class Ee{constructor(){D(this,"_handleSettingsUpdated",J(()=>{mainCal.alerts=L(mainCal.data,SETTINGS),mainCal.forceRefresh(),actionPanel.requestUpdate(),mainCal.readonly||(Y({deptId:AUTH.deptId,userId:AUTH.user.id,settings:SETTINGS},{callback:this._handleSaveComplete}),actionPanel.enableSave())},250));this.calData=null,this.settings=null,this.alerts=null,this.auth=new de("cal.html",window.location.search).auth}initEmbedMode(){new URLSearchParams(window.location.search).get("embed")=="1"&&(deptNameLabel.style.cssText="display:none !important",menu.style.cssText="display:none !important",sidebar.style.cssText="display:none !important",actionPanel.style.cssText="display:none !important")}async fetchData(t){var n;if(!t.user||t.deptId==null)throw new Error(`Unable to fetch due to invalid user and department ${(n=t.user)==null?void 0:n.id}, ${t.deptId}`);const e=ne(t.deptId),s=oe(t.deptId),a=le(t.deptId);return Promise.all([e,s,a]).then(async o=>{if(e.error||s.error||a.error)throw new Error(`Error fetching data: ${[e.error,s.error,a.error]}`);return{auth:t,dept:o[0].data,calData:o[1].data,settings:o[2].data}})}initUI({auth:t,dept:e,calData:s,settings:a}){var o;if(!t||!s||!a)throw new Error("Invalid login or user data");[this.auth,this.calData,this.settings]=[t,s,a],[window.AUTH,window.CAL_DATA,window.SETTINGS]=[t,s,a];const n=(o=t.user.user_metadata)==null?void 0:o.depts[e.id];this.renderHeader(t.user,e),calNav.classList.remove("d-none"),mainCal.loadData(s,a),mainCal.alerts=L(s,a),mainCal.readonly=!(n=="admin"||n=="edit"),calList.settings=a,peopleList.settings=a,setTimeout(()=>calNav.today(),0),logout.addEventListener("click",this._handleLogout),mainCal.addEventListener("select",this._handleCalSelect.bind(this)),mainCal.addEventListener("change",this._handleCalChange.bind(this)),calList.addEventListener("change",this._handleCalListChange.bind(this)),peopleList.addEventListener("change",this._handlePeopleChange.bind(this)),actionPanel.addEventListener("save",this._handleSave.bind(this)),window.addEventListener("beforeunload",this._checkDirtyOnUnload),document.addEventListener("keydown",this._handleHotkey.bind(this))}renderHeader(t,e){var s;!t||!t.email?userNameLabel.innerText="Not logged in":(s=t.user_metadata)!=null&&s.restricted?userNameLabel.innerText="View Only":userNameLabel.innerText=t.email,e.name&&(deptNameLabel.innerText=e.name),e.id&&(deptNameLabel.href="./cal.html?d="+e.id,settingsLink.href="./settings.html?d="+e.id,settingsLink.classList.remove("d-none"))}async _handleLogout(t){t.preventDefault(),await ie.signOut(),window.location.href="./login.html"}_handleCalSelect(t){t.detail}_handleCalChange(t){if(!mainCal.readonly){const{data:e}=t.detail,s=Object.keys(e);if(s.length>0){j({deptId:AUTH.deptId,data:e},{callback:this._handleSaveComplete}),actionPanel.enableSave();const a=L(e,this.settings);s.forEach(n=>mainCal.alerts[n]=a[n]??[]),mainCal.forceRefresh(s),actionPanel.requestUpdate()}}}_handleCalListChange(t){const{cal:e,color:s,checked:a}=t.detail;a!==void 0&&(SETTINGS.cals[e].visible=a?1:0),s!==void 0&&(SETTINGS.cals[e].color=s),this._handleSettingsUpdated()}_handlePeopleChange(t){SETTINGS=t.detail.settings,this._handleSettingsUpdated()}_handleSave(){mainCal.readonly||(j({},{callback:this._handleSaveComplete,flush:!0}),Y({},{callback:this._handleSaveComplete,flush:!0}))}_handleSaveComplete(t){t.filter(e=>e.error).length>0?(mainCal.readonly=!0,actionPanel.errorSave(),actionPanel.requestUpdate(),re("Unable to save. Please reload page.",{autohide:!1})):!W()&&!z()&&actionPanel.disableSave()}_handleHotkey(t){var a,n;const e=(n=(a=t.composedPath)==null?void 0:a.call(t))==null?void 0:n[0],s=(e==null?void 0:e.nodeName)=="INPUT"||(e==null?void 0:e.nodeName)=="DIV"&&e.contentEditable=="true";(t.ctrlKey||t.metaKey)&&t.keyCode==90&&!t.altKey&&!t.shiftKey?s||(t.preventDefault(),mainCal.undo()):(t.ctrlKey&&!t.shiftKey&&t.keyCode==89||t.metaKey&&t.shiftKey&&t.keyCode==90)&&!t.altKey?s||(t.preventDefault(),mainCal.redo()):(t.metaKey||t.ctrlKey)&&t.keyCode==83&&!t.altKey&&!t.shiftKey?(t.preventDefault(),this._handleSave()):t.altKey&&t.keyCode==84&&!t.ctrlKey&&!t.metaKey&&!t.shiftKey&&!s?(t.preventDefault(),calNav.today()):t.ctrlKey&&t.keyCode==71&&!t.metaKey&&!t.altKey&&!t.shiftKey&&(s||(t.preventDefault(),calNav.focus(),document.querySelector(".cal-navbar-datesel").click()))}_checkDirtyOnUnload(t){if(W()||z()){const e="Changes you made may not have been saved.";return(t||window.event).returnValue=e,e}}}const E=window.APP=new Ee;window.AUTH=E.auth;window.CAL_DATA=E.calData;window.SETTINGS=E.settings;document.on("DOMContentLoaded",()=>{E.initEmbedMode(),E.auth.then(h=>E.fetchData(h).then(t=>E.initUI(t)).catch(t=>{console.log(t),mainCal.loadingText="Error loading calendar. Please refresh page to try again."})).catch(h=>{console.log(h),window.location.href=E.auth.redirect})});window.importData=async function(){let[h,t]=await Promise.all([fetch("./js/2024.json"),fetch("./js/settings.json")]);[h,t]=await Promise.all([h.json(),t.json()]);const e=Object.keys(SETTINGS.cals);let s=Object.keys(t.cals);if(s.length>e.length)throw new Error("Not enough existing calendars to import. Need >= "+e.length);const a={};s=s.filter(n=>!e.includes(n)),s.forEach((n,o)=>a[n]=e[o]);for(const n of Object.values(h))Object.keys(n.cals).forEach(o=>{n.cals[o].id=a[o],n.cals[a[o]]=n.cals[o],delete n.cals[o]});j({deptId:AUTH.deptId,data:h},{flush:!0}),Object.keys(t.cals).forEach(n=>{t.cals[a[n]]=t.cals[n],delete t.cals[n]}),t.options.calOrder=t.options.calOrder.map(n=>a[n]);for(const n of t.templates)for(const o of Object.values(n.data))Object.keys(o.cals).forEach(l=>{o.cals[l].id=a[l],o.cals[a[l]]=o.cals[l],delete o.cals[l]});Y({deptId:AUTH.deptId,userId:AUTH.user.id,settings:t},{flush:!0})};
