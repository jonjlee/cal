var H=Object.defineProperty;var F=(l,e,t)=>e in l?H(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t;var b=(l,e,t)=>F(l,typeof e!="symbol"?e+"":e,t);import{s as D,i as L,x as v,E as C,T as g,a as U,w as O}from"./db-CoDloct_.js";class R extends D{connectedCallback(){super.connectedCallback(),this.addEventListener("mousedown",this._handleMouseDown),this.addEventListener("keydown",this._handleKeyDown),this.addEventListener("blur",this._commit)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mousedown",this._handleMouseDown),this.removeEventListener("keydown",this._handleKeyDown),this.removeEventListener("blur",this._commit)}render(){var u;const e=this.subitem?v`<div class="indicator">${C("caret-right")}</div>`:g,t=v`<input type="text" id="resource" size="1" placeholder="Name" list="people-list" value="${this.resource}"></input>`,s=v`<div class="divider"></div>`,i=v`<input type="text" id="schedule" size="1" placeholder="Shift" value="${this.schedule}"></input>`,o=v`<button
  ...
  `),b(M,"properties",{visible:{type:Boolean,reflect:!0},x:{type:Number},y:{type:Number},title:{type:String},content:{type:String}});customElements.define("mobile-flyout",M);function W(l,e={}){const t=e.threshold||500,s=e.moveTolerance||10,i=e.onLongPress,o=e.onTouchEnd;let n=0,a=0,u=null,p=!1;function f(d){if(d.touches.length!==1)return;const r=d.touches[0];n=r.clientX,a=r.clientY,p=!1,l.classList.add("long-press-detecting"),u=setTimeout(()=>{p=!0,i&&i({x:n,y:a,originalEvent:d})},t),setTimeout(()=>{l.classList.remove("long-press-detecting")},t+10)}function x(d){if(!u)return;const r=d.touches[0],c=Math.abs(r.clientX-n),E=Math.abs(r.clientY-a);if(c>s||E>s){m();return}}function k(d){o&&o({isLongPress:p,originalEvent:d}),m()}function w(d){m()}function m(){u&&(clearTimeout(u),u=null),l.classList.remove("long-press-detecting")}function _(){m(),l.removeEventListener("touchstart",f),l.removeEventListener("touchmove",x),l.removeEventListener("touchend",k),l.removeEventListener("touchcancel",w)}return l.addEventListener("touchstart",f,{passive:!0}),l.addEventListener("touchmove",x,{passive:!1}),l.addEventListener("touchend",k,{passive:!0}),l.addEventListener("touchcancel",w,{passive:!0}),{removeListeners:_}}class P extends D{constructor(){super(),this.data=this.data??{cals:{}},this.settings=this.settings??{cals:{}},this.longPressListeners=null}willUpdate(e){var s;if(!this.data||!this.settings)return;(((s=this.settings.options)==null?void 0:s.calOrder)??[]).forEach(i=>{this.data.cals[i]=this.data.cals[i]||{id:i,events:[]}}),this._renderInfo=this._createRenderInfo(this.data,this.alerts,this.settings,this.showAll)}_createRenderInfo(e,t,s,i){var _;const{cals:o}=e,{cals:n,options:a}=s,u=((_=a==null?void 0:a.calOrder)==null?void 0:_.map(d=>{var r,c;return(i||((r=n[d])==null?void 0:r.visible))&&!((c=n[d])!=null&&c.archived)&&o[d]}))??[],p=u.filter(d=>{var r;return d&&((r=n[d.id])==null?void 0:r.type)!=="call"}),f={type:"divider"},x=u.filter(d=>{var r;return d&&((r=n[d.id])==null?void 0:r.type)==="call"}),k=[...p,f,...x].map(({type:d,id:r,events:c})=>{var E,y;return{type:d??"event",color:(E=n[r])==null?void 0:E.color,background:(y=n[r])==null?void 0:y.background,events:c??[],alerts:t==null?void 0:t.filter(I=>I.calId==r&&I.eventIdx>=0)}});let w="",m=null;if((t==null?void 0:t.length)>0){const d=["info","warn","danger"],c=t.filter(y=>!(y.eventIdx>=0)).map(y=>d.indexOf(y.type)),E=Math.max(...c);w=d[E]?`alert-${d[E]}`:"",m=t.map(y=>y.text)}return{cals:k,alertTexts:m,alertClass:w}}render(){const{cals:e,alertText:t,alertClass:s}=this._renderInfo;if(!e)return;const i=v`
    ...
    `,o=e.map(({type:a,color:u,background:p,events:f,alerts:x})=>a=="divider"?v`<div style="flex-grow:1"></div>`:v`<cal-event-group
            borderColor="${u}"
            background="${p}"
