 ...
 */const $={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},z=r=>(...e)=>({_$litDirective$:r,values:e});class j{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=r=>r.strings===void 0,H={},W=(r,e=H)=>r._$AH=e;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=z(class extends j{constructor(r){if(super(r),r.type!==$.PROPERTY&&r.type!==$.ATTRIBUTE&&r.type!==$.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!F(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===B||e===v)return e;const t=r.element,s=r.name;if(r.type===$.PROPERTY){if(e===t[s])return B}else if(r.type===$.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return B}else if(r.type===$.ATTRIBUTE&&t.getAttribute(s)===e+"")return B;return W(r),e}}),Y=0,G=1,Q=2,S=class S extends D{constructor(){super(),this.focusOnUpdate=!1}render(){const e=this.checked==G,t=this.checked==Q,s=this.type=="confirm"?this.type:"",i=this.showHandle?h`<div class="handle">${w("grip-vertical")}</div>`:v,a=this.hideCheckbox?v:h`<input type="checkbox" id="check" .checked=${e} .indeterminate=${t} @change=${this._handleCheckChange}></input>`,n=h`<div
      id="label"
  ...
  `);customElements.define("cal-checklist",M);export{G as C,Q as I,Y as U,z as e,j as i,$ as t};
