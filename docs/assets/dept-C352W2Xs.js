import{u,y as g,z as f,A as m,B as h,C as p,D as L,k as C}from"./db-BLEYs3nM.js";document.on("DOMContentLoaded",()=>{v().then(A),loginAccessCode.on("keypress",u(loginAccessCodeBtn)),loginAccessCodeBtn.on("click",k),pendingList.on("click",D),createDeptLink.on("click",w),logoutBtn.on("click",y)});function A(){requestCalendars.classList.remove("d-none"),createDept.classList.remove("d-none"),r(),c()}async function v(){await g()||(window.location.href="./login.html")}function r(){f().then(({data:e})=>{if(e!=null&&e.length){authorizedDepts.classList.remove("d-none");const s=e.map(n=>`<li>
            <div class="list-item">
