var y=Object.defineProperty;var x=(s,e,t)=>e in s?y(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var p=(s,e,t)=>x(s,typeof e!="symbol"?e+"":e,t);import{s as u,i as w,x as c,D as g,g as D,h as G,j as S,c as L,E,F as U,G as T}from"./db-DyVQAFZi.js";import{A as O}from"./auth-M4HH7A_Q.js";import"./cal-checklist-DRamsNlK.js";class _ extends u{constructor(){super(),this._deleteMode=!1}createRenderRoot(){return this}willUpdate(e){(e.has("cal")||e.has("calId"))&&(this._deleteMode=!1)}render(){if(!this.cal)return;const{name:e,archived:t,color:a,background:l}=this.cal,n=this.cal.type==="call",i=this._deleteMode?c`<div class="fade-in">
          <p class="text-danger">
