var x=Object.defineProperty;var E=(l,e,t)=>e in l?x(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t;var h=(l,e,t)=>E(l,typeof e!="symbol"?e+"":e,t);import{s as u,i as b,x as d,n as D,E as v,g as G,j as L,k as S,e as U,F as T,G as O,H as M}from"./db-CoDloct_.js";import{A as q}from"./auth-BMg6w7gy.js";import"./cal-checklist-TOQRxQiY.js";class _ extends u{constructor(){super(),this._deleteMode=!1}createRenderRoot(){return this}willUpdate(e){(e.has("cal")||e.has("calId"))&&(this._deleteMode=!1)}render(){if(!this.cal)return;const{name:e,archived:t,color:a,background:s}=this.cal,i=this.cal.type==="call",n=this._deleteMode?d`<div class="fade-in">
          <p class="text-danger">
