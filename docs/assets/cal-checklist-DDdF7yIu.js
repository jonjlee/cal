var P=Object.defineProperty;var z=(r,e,t)=>e in r?P(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var b=(r,e,t)=>z(r,typeof e!="symbol"?e+"":e,t);import{s as D,i as A,x as h,E as w,T as v,a as O,w as N}from"./db-BFHgCUQR.js";class U extends D{connectedCallback(){super.connectedCallback(),this.addEventListener("mousedown",this._handleMouseDown),this.addEventListener("keydown",this._handleKeyDown),this.addEventListener("blur",this._commit)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mousedown",this._handleMouseDown),this.removeEventListener("keydown",this._handleKeyDown),this.removeEventListener("blur",this._commit)}render(){var u;const e=this.subitem?h`<div class="indicator">${w("caret-right")}</div>`:v,t=h`<input type="text" id="resource" size="1" placeholder="Name" list="people-list" value="${this.resource}"></input>`,s=h`<div class="divider"></div>`,i=h`<input type="text" id="schedule" size="1" placeholder="Shift" value="${this.schedule}"></input>`,l=h`<button
      id="subitem-btn"
    ...
    >
      ...
      ${w("trash-can")}
    </button>`,o=(u=this.people)!=null&&u.length?h`<datalist id="people-list">
          ${(this.people??[]).map(m=>h`<option value="${m}"></option>`)}
        </datalist>`:v;return h` <div class="inputs" @keydown=${this._handleInputKeyDown}>
        ${e} ${t} ${s} ${i}
        ${o}
      </div>
      <div class="actions">
  ...
  `),b(U,"properties",{eventindex:{type:Number,attribute:!1,noAccessor:!0},isNew:{type:Boolean},subitem:{type:Boolean},resource:{type:String},schedule:{type:String},people:{type:Array,attribute:!1},initialFocus:{type:String}});customElements.define("cal-event-edit",U);const d=class d extends D{constructor(){super(),this._editState={state:d.STATE_NOT_EDITING,eventInfoIndex:null,initialFocus:null}}willUpdate(e){this.events=this.events??[],this.settings=this.settings??{};const t=["white","black","#ffffff","#000000"];this.borderColor=t.includes(this.borderColor)?null:this.borderColor,this.background=t.includes(this.background)?null:this.background,this._renderInfo=this._createRenderInfo(this.events,this.alerts,this.settings.options,this._editState,this.readonly,this.showAll)}_createRenderInfo(e,t,s,i,l,n){const o=[],u=(s==null?void 0:s.people)??{},m=a=>{var c;return n||(((c=u[a])==null?void 0:c.visible)??!0)},g=a=>{var c;return n?null:(c=u[a])==null?void 0:c.color},_=(a,c,y)=>{var E;const f=(E=y==null?void 0:y.find(I=>I.eventIdx==a))==null?void 0:E.type;return f?`alert-${f}`:""},C=(a,c,y,f)=>{var I;const E=typeof c.schedule=="object"?c.schedule.join(", "):c.schedule;o.push({type:"event",subitem:a,color:g((I=c.resource)==null?void 0:I.toLowerCase()),alertClass:_(y,f,t),resource:c.resource,schedule:E,eventInfoIndex:o.length,eventIndex:y,eventSubitemIndex:f})};if(e.forEach((a,c)=>{var f,E,I;const y=(f=a.subitems)==null?void 0:f.find(L=>{var B;return m((B=L.resource)==null?void 0:B.toLowerCase())});(m((E=a.resource)==null?void 0:E.toLowerCase())||y)&&(C(!1,a,c,null),(I=a.subitems)==null||I.forEach((L,B)=>{var V;m((V=L.resource)==null?void 0:V.toLowerCase())&&C(!0,L,c,B)}))}),i.state==d.STATE_ADD_EVENT)o.push({type:"edit",subitem:!1,resource:"",schedule:"",eventInfoIndex:o.length,eventIndex:this.events.length,eventSubitemIndex:null,editState:i});else if(i.state==d.STATE_ADD_SUBITEM){const a=o[i.eventInfoIndex],c={type:"edit",subitem:!0,resource:"",schedule:"",eventInfoIndex:i.eventInfoIndex+1,eventIndex:a.eventIndex,eventSubitemIndex:a.eventSubitemIndex,editState:i};o.splice(i.eventInfoIndex+1,0,c)}else if(i.state==d.STATE_EDIT_EVENT){const a=o[i.eventInfoIndex];a.type="edit",a.editState=i}const T=!l&&i.state!==d.STATE_ADD_EVENT,x=o.length==0?"expanded":"",k={visible:T,class:x},p=Object.entries((s==null?void 0:s.people)??{}).filter(([a,c])=>n||(c.visible??!0)).map(([a,c])=>c.name).sort();return{eventInfos:o,addButton:k,peopleList:p}}render(){const e=this.background&&`background: ${this.background};`,t=this.borderColor&&`border-color: ${this.borderColor};`,{eventInfos:s,addButton:i,peopleList:l}=this._renderInfo,n=t?h`<div class="cal-event-group-border" style="${t}"></div>`:v,o=s.map(({type:g,subitem:_,color:C,alertClass:T,resource:x,schedule:k,eventInfoIndex:p,editState:a})=>{if(g==="event"){const c=_?w("caret-right"):v;return h`<div
  ...
  `),b(d,"properties",{borderColor:{type:String},background:{type:String},events:{type:Object,attribute:!1},alerts:{type:Object,attribute:!1},settings:{type:Object,attribute:!1},readonly:{type:Boolean},showAll:{type:Boolean}}),b(d,"STATE_NOT_EDITING",0),b(d,"STATE_ADD_EVENT",1),b(d,"STATE_ADD_SUBITEM",2),b(d,"STATE_EDIT_EVENT",3),b(d,"_dragged",null);let R=d;customElements.define("cal-event-group",R);class K extends D{constructor(){super(),this.data=this.data??{cals:{}},this.settings=this.settings??{cals:{}}}willUpdate(e){var s;if(!this.data||!this.settings)return;(((s=this.settings.options)==null?void 0:s.calOrder)??[]).forEach(i=>{this.data.cals[i]=this.data.cals[i]||{id:i,events:[]}}),this._renderInfo=this._createRenderInfo(this.data,this.alerts,this.settings,this.showAll)}_createRenderInfo(e,t,s,i){var k;const{cals:l}=e,{cals:n,options:o}=s,u=((k=o==null?void 0:o.calOrder)==null?void 0:k.map(p=>{var a,c;return(i||((a=n[p])==null?void 0:a.visible))&&!((c=n[p])!=null&&c.archived)&&l[p]}))??[],m=u.filter(p=>{var a;return p&&((a=n[p.id])==null?void 0:a.type)!=="call"}),g={type:"divider"},_=u.filter(p=>{var a;return p&&((a=n[p.id])==null?void 0:a.type)==="call"}),C=[...m,g,..._].map(({type:p,id:a,events:c})=>{var y,f;return{type:p??"event",color:(y=n[a])==null?void 0:y.color,background:(f=n[a])==null?void 0:f.background,events:c??[],alerts:t==null?void 0:t.filter(E=>E.calId==a&&E.eventIdx>=0)}});let T="",x=null;if((t==null?void 0:t.length)>0){const p=["info","warn","danger"],c=t.filter(f=>!(f.eventIdx>=0)).map(f=>p.indexOf(f.type)),y=Math.max(...c);T=p[y]?`alert-${p[y]}`:"",x=t.map(f=>f.text)}return{cals:C,alertTexts:x,alertClass:T}}render(){const{cals:e,alertText:t,alertClass:s}=this._renderInfo;if(!e)return;const i=h`
    ...
    `,l=e.map(({type:o,color:u,background:m,events:g,alerts:_})=>o=="divider"?h`<div style="flex-grow:1"></div>`:h`<cal-event-group
            borderColor="${u}"
            background="${m}"
  ...
  `),b(K,"properties",{day:{type:String},note:{type:String},noteStyle:{type:String},readonly:{type:Boolean},selected:{type:Boolean},dim:{type:Boolean},showAll:{type:Boolean},data:{type:Object,attribute:!1},alerts:{type:Object,attribute:!1},settings:{type:Object,attribute:!1}});customElements.define("cal-day",K);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},j=r=>(...e)=>({_$litDirective$:r,values:e});class F{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const H=r=>r.strings===void 0,W={},J=(r,e=W)=>r._$AH=e;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Y=j(class extends F{constructor(r){if(super(r),r.type!==$.PROPERTY&&r.type!==$.ATTRIBUTE&&r.type!==$.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!H(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===N||e===v)return e;const t=r.element,s=r.name;if(r.type===$.PROPERTY){if(e===t[s])return N}else if(r.type===$.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return N}else if(r.type===$.ATTRIBUTE&&t.getAttribute(s)===e+"")return N;return J(r),e}}),G=0,Q=1,X=2,S=class S extends D{constructor(){super(),this.focusOnUpdate=!1}render(){const e=this.checked==Q,t=this.checked==X,s=this.type=="confirm"?this.type:"",i=this.showHandle?h`<div class="handle">${w("grip-vertical")}</div>`:v,l=this.hideCheckbox?v:h`<input type="checkbox" id="check" .checked=${e} .indeterminate=${t} @change=${this._handleCheckChange}></input>`,n=h`<div
      id="label"
    ...
    ></div>`,o=this.hideColor?v:this.renderColorSelector(this.color),u=this.showDelete?h`<div class="deleteBtn" @click=${this._handleDeleteClick}>
          ${w("xmark")}
    ...
    >
      ${l} ${o} ${n} ${g} ${i}
    </div> `}renderColorSelector(e){return e=e??S.DEFAULT_COLOR,h`<div class="color-selector" @click=${this._handleColorSelectClick}>
  ...
  `);let q=S;customElements.define("cal-checklist-item",q);class M extends D{constructor(){super(),this.items=[],this.selected=-1,this.deleteIdx=-1}willUpdate(e){this.items=this.items??[],this._renderInfo=this._createRenderInfo(this.items,this.selected,this.deleteIdx),this.items.forEach(t=>delete t.editing)}_createRenderInfo(e,t,s){const i=[];return e.forEach(({id:l,label:n,color:o,checked:u,editing:m},g)=>{i.push({type:"item",id:l,label:n,color:o,checked:u,editing:m,selected:t==g,context:{index:g}})}),s>=0&&s<e.length&&i.splice(s+1,0,{type:"confirm",label:this.deleteWarning,context:{index:s,confirmed:!0}}),{itemInfos:i}}render(){if(!this._renderInfo)return v;const e=this._renderInfo.itemInfos.map((s,i)=>h`<cal-checklist-item
        type=${s.type}
        label=${s.label}
        color=${s.color}
        checked=${s.checked}
  ...
  `);customElements.define("cal-checklist",M);export{Q as C,X as I,G as U,j as e,F as i,$ as t};
