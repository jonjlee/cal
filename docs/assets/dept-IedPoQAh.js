import{y as u,A as g,B as f,C as m,D as h,E as p,F as L,m as C}from"./db-D5gLqEhL.js";document.on("DOMContentLoaded",()=>{v().then(A),loginAccessCode.on("keypress",u(loginAccessCodeBtn)),loginAccessCodeBtn.on("click",D),pendingList.on("click",k),createDeptLink.on("click",w),logoutBtn.on("click",y)});function A(){requestCalendars.classList.remove("d-none"),createDept.classList.remove("d-none"),r(),c()}async function v(){await g()||(window.location.href="./login.html")}function r(){f().then(({data:e})=>{if(e!=null&&e.length){authorizedDepts.classList.remove("d-none");const s=e.map(n=>`<li>
            <div class="list-item">
