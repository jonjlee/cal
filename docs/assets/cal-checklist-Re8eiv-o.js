var V=Object.defineProperty;var z=(r,e,t)=>e in r?V(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var b=(r,e,t)=>z(r,typeof e!="symbol"?e+"":e,t);import{s as D,i as A,x as h,D as w,T as v,H as O,w as N}from"./db-gBYaOoHZ.js";class U extends D{connectedCallback(){super.connectedCallback(),this.addEventListener("mousedown",this._handleMouseDown),this.addEventListener("keydown",this._handleKeyDown),this.addEventListener("blur",this._commit)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("mousedown",this._handleMouseDown),this.removeEventListener("keydown",this._handleKeyDown),this.removeEventListener("blur",this._commit)}render(){var u;const e=this.subitem?h`<div class="indicator">${w("caret-right")}</div>`:v,t=h`<input type="text" id="resource" size="1" placeholder="Name" list="people-list" value="${this.resource}"></input>`,s=h`<div class="divider"></div>`,i=h`<input type="text" id="schedule" size="1" placeholder="Shift" value="${this.schedule}"></input>`,a=h`<button
  ...
  `),b(U,"properties",{eventindex:{type:Number,attribute:!1,noAccessor:!0},isNew:{type:Boolean},subitem:{type:Boolean},resource:{type:String},schedule:{type:String},people:{type:Array,attribute:!1},initialFocus:{type:String}});customElements.define("cal-event-edit",U);const d=class d extends D{constructor(){super(),this._editState={state:d.STATE_NOT_EDITING,eventInfoIndex:null,initialFocus:null}}willUpdate(e){this.events=this.events??[],this.settings=this.settings??{};const t=["white","black","#ffffff","#000000"];this.borderColor=t.includes(this.borderColor)?null:this.borderColor,this.background=t.includes(this.background)?null:this.background,this._renderInfo=this._createRenderInfo(this.events,this.alerts,this.settings.options,this._editState,this.readonly,this.showAll)}_createRenderInfo(e,t,s,i,a,n){const l=[],u=(s==null?void 0:s.people)??{},m=o=>{var c;return n||(((c=u[o])==null?void 0:c.visible)??!0)},g=o=>{var c;return n?null:(c=u[o])==null?void 0:c.color},_=(o,c,y)=>{var E;const f=(E=y==null?void 0:y.find(I=>I.eventIdx==o))==null?void 0:E.type;return f?`alert-${f}`:""},C=(o,c,y,f)=>{var I;const E=typeof c.schedule=="object"?c.schedule.join(", "):c.schedule;l.push({type:"event",subitem:o,color:g((I=c.resource)==null?void 0:I.toLowerCase()),alertClass:_(y,f,t),resource:c.resource,schedule:E,eventInfoIndex:l.length,eventIndex:y,eventSubitemIndex:f})};if(e.forEach((o,c)=>{var f,E,I;const y=(f=o.subitems)==null?void 0:f.find(L=>{var B;return m((B=L.resource)==null?void 0:B.toLowerCase())});(m((E=o.resource)==null?void 0:E.toLowerCase())||y)&&(C(!1,o,c,null),(I=o.subitems)==null||I.forEach((L,B)=>{var P;m((P=L.resource)==null?void 0:P.toLowerCase())&&C(!0,L,c,B)}))}),i.state==d.STATE_ADD_EVENT)l.push({type:"edit",subitem:!1,resource:"",schedule:"",eventInfoIndex:l.length,eventIndex:this.events.length,eventSubitemIndex:null,editState:i});else if(i.state==d.STATE_ADD_SUBITEM){const o=l[i.eventInfoIndex],c={type:"edit",subitem:!0,resource:"",schedule:"",eventInfoIndex:i.eventInfoIndex+1,eventIndex:o.eventIndex,eventSubitemIndex:o.eventSubitemIndex,editState:i};l.splice(i.eventInfoIndex+1,0,c)}else if(i.state==d.STATE_EDIT_EVENT){const o=l[i.eventInfoIndex];o.type="edit",o.editState=i}const T=!a&&i.state!==d.STATE_ADD_EVENT,x=l.length==0?"expanded":"",k={visible:T,class:x},p=Object.entries((s==null?void 0:s.people)??{}).filter(([o,c])=>n||(c.visible??!0)).map(([o,c])=>c.name).sort();return{eventInfos:l,addButton:k,peopleList:p}}render(){const e=this.background&&`background: ${this.background};`,t=this.borderColor&&`border-color: ${this.borderColor};`,{eventInfos:s,addButton:i,peopleList:a}=this._renderInfo,n=t?h`<div class="cal-event-group-border" style="${t}"></div>`:v,l=s.map(({type:g,subitem:_,color:C,alertClass:T,resource:x,schedule:k,eventInfoIndex:p,editState:o})=>{if(g==="event"){const c=_?w("caret-right"):v;return h`<div
 ...
 */const Y=j(class extends F{constructor(r){if(super(r),r.type!==$.PROPERTY&&r.type!==$.ATTRIBUTE&&r.type!==$.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!H(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===N||e===v)return e;const t=r.element,s=r.name;if(r.type===$.PROPERTY){if(e===t[s])return N}else if(r.type===$.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return N}else if(r.type===$.ATTRIBUTE&&t.getAttribute(s)===e+"")return N;return J(r),e}}),G=0,Q=1,X=2,S=class S extends D{constructor(){super(),this.focusOnUpdate=!1}render(){const e=this.checked==Q,t=this.checked==X,s=this.type=="confirm"?this.type:"",i=this.showHandle?h`<div class="handle">${w("grip-vertical")}</div>`:v,a=this.hideCheckbox?v:h`<input type="checkbox" id="check" .checked=${e} .indeterminate=${t} @change=${this._handleCheckChange}></input>`,n=h`<div
  ...
  `);let q=S;customElements.define("cal-checklist-item",q);class M extends D{constructor(){super(),this.items=[],this.selected=-1,this.deleteIdx=-1}willUpdate(e){this.items=this.items??[],this._renderInfo=this._createRenderInfo(this.items,this.selected,this.deleteIdx),this.items.forEach(t=>delete t.editing)}_createRenderInfo(e,t,s){const i=[];return e.forEach(({id:a,label:n,color:l,checked:u,editing:m},g)=>{i.push({type:"item",id:a,label:n,color:l,checked:u,editing:m,selected:t==g,context:{index:g}})}),s>=0&&s<e.length&&i.splice(s+1,0,{type:"confirm",label:this.deleteWarning,context:{index:s,confirmed:!0}}),{itemInfos:i}}render(){if(!this._renderInfo)return v;const e=this._renderInfo.itemInfos.map((s,i)=>h`<cal-checklist-item
        type=${s.type}
        label=${s.label}
        color=${s.color}
        checked=${s.checked}
